                    ...
                    <div key={d.id} className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                        <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                                ...
                                <div className="mt-1 font-semibold text-slate-900 truncate">{d.nama}</div>
                                <div className="mt-2 space-y-1 text-sm text-slate-600">
                                    <div><span className="font-medium">NIDN:</span> {d.nidn}</div>
                                    <div><span className="font-medium">Prodi:</span> {d.prodi}</div>
                                    <div><span className="font-medium">ID:</span> {d.id}</div>
                                </div>
                            </div>
